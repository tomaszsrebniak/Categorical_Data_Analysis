...
Na poziomie istotności $\alpha = 0.05$ nie mamy podstaw do odrzucenia hipotezy zerowej o symetrii. Zakładamy, że leki są jednakowo skuteczne.
...
Na poziomie istotności $\alpha = 0.05$ nie mamy podstaw do odrzucenia hipotezy zerowej o symetrii. Zakładamy, że odpowiedzi w pierwszym badanym okresie i w drugim okresie odpowiadają modelowi symetrii. Na podstawie uzyskanych wyników możemy przyjąć hipotezę, że ocena podejścia firmy nie uległa zmianie.
...
P--value uzyskane w teście wynosi `r round(p_value, 4)`. Na poziomie istotności $\alpha = 0.05$ odrzucamy hipotezę zerową na rzecz hipotezy alternatywnej. Zakładamy, że zmienne losowe **CZY_KIER**, **PYT_2** i **STAŻ** są nie wzajemnie niezależne.
